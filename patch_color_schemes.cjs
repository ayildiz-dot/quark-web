...
// 1. App.css — Midnight scheme
patchFile('src/App.css', 'Midnight scheme colors',
`/* Midnight */
...
// 2. App.css — Slate scheme
patchFile('src/App.css', 'Slate scheme colors',
`/* Slate */
...
// 3. App.css — Crimson scheme
patchFile('src/App.css', 'Crimson scheme colors',
`/* Crimson */
...
// 4. Navbar.jsx — swatch dots in the picker
patchFile('src/components/Navbar.jsx', 'Navbar SCHEMES swatches',
...
if (!ok) {
  ...
  console.log('\n✅ All color scheme patches applied.');
}
